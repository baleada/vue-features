<template>
  ...
  <div class="flex gap-4">
    ...
    <div :ref="separator.root.ref({ controls: el1.id.value, label: 'change pane width', describedBy: description.id.value })" class="w-1 h-6 bg-blue-600"></div>
    <div ref="el2">vue features</div>
  </div>
  <div :ref="description.ref()">My special separator</div>
</template>
